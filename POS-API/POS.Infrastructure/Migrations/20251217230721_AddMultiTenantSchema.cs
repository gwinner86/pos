        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyPrimaryPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyOtherPhoneNumbers = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureId = table.Column<int>(type: "int", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SpecificFeature = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecificFeatureValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFeatureAssignments", x => x.AssignmentId);
                    table.ForeignKey(
                        ...
                        principalColumn: "CompanyId");
                    table.ForeignKey(
                        name: "FK_TenantFeatureAssignments_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "FeatureId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantFeatureAssignments_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCompanyAssignments_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId");
                    table.ForeignKey(
                        name: "FK_UserCompanyAssignments_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantFeatureAssignments_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantFeatureAssignments_LocationId",
                table: "TenantFeatureAssignments",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantFeatureAssignments_TenantId",
                table: "TenantFeatureAssignments",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyAssignments_LocationId",
                table: "UserCompanyAssignments",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyAssignments_RoleId",
                table: "UserCompanyAssignments",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyAssignments_UserId_CompanyId_RoleId",
                table: "UserCompanyAssignments",
