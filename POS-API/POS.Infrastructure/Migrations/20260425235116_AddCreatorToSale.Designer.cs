...
namespace POS.Infrastructure.Migrations
{
    ...
    [Migration("20260425235116_AddCreatorToSale")]
    partial class AddCreatorToSale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Domain.Entities.SetupCountry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("POS.Domain.Entities.SetupExpenseType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SetupExpenseTypes");
                });

            modelBuilder.Entity("POS.Domain.Entities.SetupVAT", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("POS.Domain.Entities.Expense", b =>
                {
                    b.HasOne("POS.Domain.Entities.SetupExpenseType", "ExpenseType")
                        .WithMany()
                        .HasForeignKey("ExpenseTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POS.Domain.Entities.GLAccount", "PaymentAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("POS.Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("POS.Domain.Entities.User", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("POS.Domain.Entities.SetupExpenseType", b =>
                {
                    b.HasOne("POS.Domain.Entities.GLAccount", "ExpenseAccount")
                        .WithMany()
